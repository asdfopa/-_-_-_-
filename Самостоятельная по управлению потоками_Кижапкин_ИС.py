...
print(random_number) #Вай все четко
if random_number ==1:
...
mini = int(input('Ввелите минимум '))
srednee = int(input('Введите среднее значение '))
stan_ot = int(input('Введите стандартное отклонение '))

if (maxim - srednee > 3*stan_ot) or (srednee - mini > 3*stan_ot):
    print('В ваших данных имеются выбросы и требуют переработки')

elif (maxim - srednee > 5*stan_ot) or (srednee - mini > 5*stan_ot):
    print('В ваших данных имеются экстремальные значения и требуют переработки')

elif (maxim - srednee <= 3*stan_ot) or (srednee - mini <= 3*stan_ot):
...
"""latte_makiattee = input('Введите название кофе ')
if latte_makiattee == 'Капучино':
...
elif latte_makiattee == 'Фрапучино':
...
print(result)
print(f"\nКоды: {code1}, {code2}, {code3}, {code4}")""" #Задание 6
